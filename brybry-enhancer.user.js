...
margin-bottom: 2px;
    ...
    .tooltip .be-status-chance-multiplier,
...
`;
  ...
  const ENHANCER_VERSION = "1.11.130";
  ...
  const COPY = {
    en: {
      ...
      statusChanceMultiplier: "Status chance multiplier: ×{value}",
    ...
    fr: {
      ...
      statusChanceMultiplier: "Multiplicateur de probabilité d’altération : ×{value}",
    ...
    de: {
      ...
      statusChanceMultiplier: "Statuschance-Multiplikator: ×{value}",
    ...
    es: {
      ...
      statusChanceMultiplier: "Multiplicador de probabilidad de estado: ×{value}",
    ...
    it: {
      ...
      statusChanceMultiplier: "Moltiplicatore della probabilità di stato: ×{value}",
    ...
    ja: {
      ...
      statusChanceMultiplier: "異常確率倍率: ×{value}",
    ...
    ko: {
      ...
      statusChanceMultiplier: "상태 이상 확률 배율: ×{value}",
    ...
    zh: {
      ...
      multiplier: "倍率：+{value}%",
      multiplierCap: "倍率上限：+{value}%",
      statusChanceMultiplier: "異常機率倍率：×{value}",
