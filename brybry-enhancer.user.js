...
margin-bottom: 2px;
    ...
    .tooltip .be-affected-moves strong {
color: #fff;
display: block;
font-size: 11.5px;
line-height: 1.3;
margin-bottom: 4px;
    ...
    .tooltip .be-affected-moves span {
display: block;
font-weight: 650;
padding: 1px 0;
    }
    ...
    .tooltip .be-additional-effect-chance-multiplier,
    .tooltip .be-damage-reduction,
    .tooltip .be-healing-boost,
    .tooltip .be-status-effect-reduction,
...
border-color: #27758b;
    ...
    #pairSearchModal .be-filter-options {
margin-left: auto;
position: relative;
    }

    #pairSearchModal .be-filter-options > summary { list-style: none; }
    #pairSearchModal .be-filter-options > summary::-webkit-details-marker { display: none; }

    #pairSearchModal .be-filter-options-button {
align-items: center;
appearance: none;
background: transparent;
border: 0;
...
width: 32px;
    ...
    #pairSearchModal .be-filter-options-button:hover,
    #pairSearchModal .be-filter-options[open] .be-filter-options-button { background: rgba(44, 104, 120, .08); color: #24586a; }
    #pairSearchModal .be-filter-options-button:focus-visible { outline: 3px solid rgba(54, 126, 201, .45); outline-offset: 2px; }
    #pairSearchModal .be-filter-options-button svg { fill: currentColor; height: 20px; width: 20px; }

    #pairSearchModal .be-filter-options-menu {
background: #fff;
border: 1px solid rgba(44, 104, 120, .18);
border-radius: 9px;
box-shadow: 0 8px 24px rgba(20, 45, 52, .16);
min-width: 200px;
padding: 5px;
position: absolute;
right: 0;
...
z-index: 12;
    ...
    #pairSearchModal .be-reset-filter-order {
appearance: none;
background: transparent;
border: 0;
border-radius: 6px;
color: #315f6c;
cursor: pointer;
font: 650 13px/1.25 system-ui, -apple-system, BlinkMacSystemFont, sans-serif;
padding: 9px 10px;
text-align: left;
width: 100%;
    }
    #pairSearchModal .be-reset-filter-order:hover { background: rgba(44, 104, 120, .08); color: #24586a; }
    #pairSearchModal .be-reset-filter-order:focus-visible { box-shadow: inset 0 0 0 2px rgba(39, 117, 139, .55); outline: 0; }
...
text-transform: none;
    ...
    #pairSearchModal details.be-filter-section > summary.be-accordion-trigger:active { cursor: grabbing; }

    #pairSearchModal .be-filter-section-handle {
align-items: center;
background: transparent;
border: 0;
border-radius: 4px;
...
width: 22px;
    ...
    #pairSearchModal .be-filter-section-handle:hover,
    #pairSearchModal .be-filter-section-handle:focus-visible { background: rgba(44, 104, 120, .1); opacity: 1; outline: 0; }
    #pairSearchModal .be-filter-section-handle:active { cursor: grabbing; }
    #pairSearchModal .be-filter-section-handle svg { fill: currentColor; height: 16px; width: 16px; }
    #pairSearchModal details.be-filter-section--dragging { opacity: .45; }
    #pairSearchModal details.be-filter-section--drop-target { box-shadow: inset 0 3px 0 #25849d; }
...
outline-offset: -1px;
    ...
    #pairSearchModal #pairSearchResults .pair-images--fallback,
    #openPairSearchBtn #fabPairIcons.be-fab-pair-fallback {
background: linear-gradient(135deg, #f5fafb, #e8f3f6);
height: 75px;
overflow: hidden;
position: relative;
width: 75px;
...
outline-offset: -1px;
    ...
    #openPairSearchBtn #fabPairIcons.be-fab-pair-fallback {
border-radius: 50%;
box-shadow: inset 0 0 0 1px rgba(18, 56, 125, .16);
flex: 0 0 75px;
    }

    #pairSearchModal #pairSearchResults .be-pair-avatar--fallback,
    #openPairSearchBtn #fabPairIcons.be-fab-pair-fallback .be-pair-avatar--fallback {
border-radius: 0;
bottom: 0;
height: 75px;
object-fit: contain;
...
width: 47px;
    ...
    #pairSearchModal #pairSearchResults .be-pair-avatar--fallback-trainer,
    #openPairSearchBtn #fabPairIcons.be-fab-pair-fallback .be-pair-avatar--fallback-trainer {
left: 0;
object-fit: cover;
object-position: center bottom;
    }

    #pairSearchModal #pairSearchResults .be-pair-avatar--fallback-pokemon,
    #openPairSearchBtn #fabPairIcons.be-fab-pair-fallback .be-pair-avatar--fallback-pokemon {
...
width: 40px;
    ...
    /* On phones, the Grid is the primary task. Keep the settings below it so
       their fixed-width controls cannot collapse the Grid into an unusable sliver. */
    .be-grid-picker {
...
width: 100%;
    ...
    .be-grid-picker > :not(.be-grid-wrapper) {
...
.be-grid-picker > :not(.be-grid-wrapper) { margin: auto 25px !important; }
    }
...
`;
  ...
  const ENHANCER_VERSION = "1.11.148";
  ...
  const COPY = {
    en: {
      ...
      include: "Include",
      exclude: "Exclude",
      moveFilterSection: "Move {name}",
      filterOptions: "Filter options",
      resetFilterOrder: "Reset filter order",
      nameSearch: "Name",
      ...
      additionalEffectChanceMultiplier: "Additional-effect chance multiplier: ×{value}",
      damageReduction: "Damage reduction: {value}%",
      healingBoost: "Healing move recovery boost: +{value}%",
      statusEffectReduction: "Status/interference effect reduction: {value}%",
      ...
      affectedMoves: "Affected moves with limited uses",
    ...
    fr: {
      ...
      include: "Inclure",
      exclude: "Exclure",
      moveFilterSection: "Déplacer {name}",
      filterOptions: "Options des filtres",
      resetFilterOrder: "Réinitialiser l’ordre des filtres",
      nameSearch: "Nom",
      ...
      additionalEffectChanceMultiplier: "Multiplicateur de probabilité d’effet additionnel : ×{value}",
      damageReduction: "Réduction des dégâts : {value} %",
      healingBoost: "Bonus de soins des capacités : +{value} %",
      statusEffectReduction: "Réduction des effets de statut/entrave : {value} %",
      ...
      affectedMoves: "Capacités affectées à utilisations limitées",
      relatedMove: "Capacité liée : {name}",
      movePower: "Puissance {value}",
      moveAccuracy: "Précision {value} %",
      moveUses: "Utilisations {value}",
    ...
    de: {
      ...
      moveFilterSection: "{name} verschieben",
      filterOptions: "Filteroptionen",
      resetFilterOrder: "Filterreihenfolge zurücksetzen",
      nameSearch: "Name",
      ...
      additionalEffectChanceMultiplier: "Multiplikator für Zusatzeffektchance: ×{value}",
      damageReduction: "Schadensreduktion: {value} %",
      healingBoost: "Heilungsbonus durch Attacken: +{value} %",
      statusEffectReduction: "Status-/Störungseffekt-Reduktion: {value} %",
    ...
    es: {
      ...
      include: "Incluir",
      exclude: "Excluir",
      moveFilterSection: "Mover {name}",
      filterOptions: "Opciones de filtros",
      resetFilterOrder: "Restablecer orden de filtros",
      nameSearch: "Nombre",
      ...
      additionalEffectChanceMultiplier: "Multiplicador de probabilidad de efecto adicional: ×{value}",
      damageReduction: "Reducción de daño: {value} %",
      healingBoost: "Aumento de curación de movimientos: +{value} %",
      statusEffectReduction: "Reducción de efectos de estado/interferencia: {value} %",
      ...
      affectedMoves: "Movimientos afectados con usos limitados",
    ...
    it: {
      ...
      include: "Includi",
      exclude: "Escludi",
      moveFilterSection: "Sposta {name}",
      filterOptions: "Opzioni filtri",
      resetFilterOrder: "Reimposta ordine filtri",
      nameSearch: "Nome",
      ...
      additionalEffectChanceMultiplier: "Moltiplicatore della probabilità di effetto aggiuntivo: ×{value}",
      damageReduction: "Riduzione danni: {value}%",
      healingBoost: "Aumento recupero delle mosse curative: +{value}%",
      statusEffectReduction: "Riduzione effetti di stato/interferenza: {value}%",
    ...
    ja: {
      ...
      include: "含む",
      exclude: "除外",
      moveFilterSection: "{name}を移動",
      filterOptions: "フィルタのオプション",
      resetFilterOrder: "フィルタの順序をリセット",
      nameSearch: "名前",
    ...
    ko: {
      ...
      include: "포함",
      exclude: "제외",
      moveFilterSection: "{name} 이동",
      filterOptions: "필터 옵션",
      resetFilterOrder: "필터 순서 초기화",
      nameSearch: "이름",
    ...
    zh: {
      ...
      include: "包含",
      exclude: "排除",
      moveFilterSection: "移動{name}",
      filterOptions: "篩選選項",
      resetFilterOrder: "重設篩選順序",
      nameSearch: "名稱",
      ...
      multiplier: "倍率：+{value}%",
      multiplierCap: "倍率上限：+{value}%",
      additionalEffectChanceMultiplier: "附加效果機率倍率：×{value}",
      damageReduction: "傷害減輕：{value}%",
      healingBoost: "HP回復招式回復量：+{value}%",
      statusEffectReduction: "異常／妨害狀態效果減輕：{value}%",
      fieldDurationBase: "場地效果時間：約 {value} 秒（一般速度）",
      fieldDurationExtension: "此技能延長：約 +{value} 秒",
      requiredMoveLevel: "所需招式等級：{value}/5",
      affectedMoves: "受影響的次數限制招式",
  ...
  function appendDamageReduction(tooltip, moveInfo) {
    ...
    const reduction = Number.isFinite(moveInfo?.damageReduction) ? moveInfo.damageReduction : damageReductionForPassiveId(moveInfo?.passiveId, description);
  ...
  function normalizedMoveReference(value) {
    return normalizeGridLabel(value).normalize("NFKC").toLocaleLowerCase().replace(/[\s'"‘’“”「」『』:：・･]/g, "");
  }
  ...
  function relatedMovesForTooltip(moveInfo, tile) {
    ...
    const relatedMoves = explicitMoves.length ? explicitMoves : movesReferencedByTileName(tile, moveInfo);
    return moveInfo?.recoversMoveUses ? relatedMoves.filter((relatedMove) => relatedMove.moveUses > 0) : relatedMoves;
  }
  function appendRelatedMoveDescription(tooltip, moveInfo, tile) {
    if (!tooltip || !moveInfo || moveInfo.abilityType === 11 || tooltip.querySelector(".be-related-move")) return;
  ...
  const ADDITIONAL_EFFECT_CHANCE_MULTIPLIER_FAMILIES = /* @__PURE__ */ new Set([
    220101,
    // Hostile Environment
    220102,
    // Aggravation
  ...
  function abilityTargetsWholeMoveSet(ability) {
    ...
    return skillTemplate.includes(" 技回数回復") || skillTemplate.includes("P技後 回数回復");
  }
  ...
  function moveIdsForTrainer(trainerId) {
    ...
    return [...new Set([1, 2, 3, 4].map((slot) => String(trainer?.[`move${slot}Id`] || "")).filter((moveId) => moveById.has(moveId)))];
  }
  ...
  function skillCategoryLogicGroup(value) {
    ...
    return SKILL_FILTER_LOGIC_GROUPS.find((group) => group.parentValues.includes(parentValue))?.key || `skillCategory:${parentValue}`;
  }
  ...
  function pairFallbackIcons(trainer) {
    ...
    const monsterBase = monsterBaseById.get(String(monster?.monsterBaseId));
    return {
      trainer: trainerBase?.actorId ? new URL(`./data/actor/Trainer/${trainerBase.actorId}/${trainerBase.actorId}_1024.png`, location.href).href : "",
      pokemon: monsterBase?.actorId ? new URL(`./data/actor/Monster/${monsterBase.actorId}/${monsterBase.actorId}_256.png`, location.href).href : "",
  ...
  function activeFilterEntries() {
    ...
    Object.entries({
      ...
      values.forEach((value) => entries.push({
        ...
        value,
        state: "include",
        label: activeFilterLabel(group, chipLabel(group, value)),
        logicGroup: filterLogicGroup(group, value)
      }));
    ...
    selectedSkillCategories.forEach((value) => entries.push({
      ...
      value,
      state: "include",
      label: activeSkillCategoryLabel(value, locale),
      logicGroup: skillCategoryLogicGroup(value)
    }));
  ...
  function pairMatches(pair, query, locale = language()) {
    ...
    const includedMatchesByGroup = /* @__PURE__ */ new Map();
    ...
    selectedSkillCategories.forEach((value) => {
      ...
      addIncludedMatches(skillCategoryLogicGroup(value), /* @__PURE__ */ new Set([value]), () => category ? pairMatchesSkillCategory(pair, category, locale) : true);
    });
  ...
  function applyFilterSectionOrder(panel) {
    ...
    const unknownGroups = sections.map((section) => section.dataset.beGroup).filter((group) => !savedGroups.includes(group) && !defaultGroups.includes(group));
  ...
  function bindFilterSectionSorting(panel) {
    ...
    let openSectionsBeforeDrag = /* @__PURE__ */ new Map();
    ...
    const clearDropTargets = () => panel.querySelectorAll(".be-filter-section--drop-target").forEach((section) => section.classList.remove("be-filter-section--drop-target"));
    const restoreSectionsAfterDrag = () => {
      ...
      openSectionsBeforeDrag = /* @__PURE__ */ new Map();
      draggedSectionTop = null;
      draggedSection = null;
      window.setTimeout(() => {
        filterSectionsReordering = false;
      }, 0);
    };
    panel.addEventListener("dragstart", (event) => {
      ...
      openSectionsBeforeDrag = new Map(orderedFilterSections(panel).map((section) => [section.dataset.beGroup, section.open]));
      orderedFilterSections(panel).forEach((section) => {
        section.open = false;
      });
      preserveDraggedSectionPosition();
  ...
  function skillSearchField() {
    ...
    SKILL_FILTER_LOGIC_GROUPS.forEach(({ key, parentValues }) => {
      const title = key === "skillMasterPassive" ? SKILL_FILTER_CATEGORIES.find((category) => category.value === "masterPassive")?.labels?.[locale] || "Master Passive" : copy[key];
