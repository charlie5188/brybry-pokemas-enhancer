...
color: #527883;
cursor: pointer;
font: 650 12px/1.2 system-ui, -apple-system, BlinkMacSystemFont, sans-serif;
margin: 10px 0 2px;
padding: 5px 2px;
text-decoration: underline;
text-underline-offset: 2px;
    }
    #pairSearchModal .be-reset-filter-order:hover { color: #24586a; }
    #pairSearchModal .be-reset-filter-order:focus-visible { border-radius: 4px; box-shadow: 0 0 0 2px rgba(39, 117, 139, .55); outline: 0; }
...
`;
  ...
  const ENHANCER_VERSION = "1.11.135";
