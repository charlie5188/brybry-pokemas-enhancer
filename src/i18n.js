const COPY = {
  en: {
    ...
    relatedMove: 'Related move: {name}', movePower: 'Power {value}', moveAccuracy: 'Accuracy {value}%',
  ...
  fr: {
    ...
    relatedMove: 'Capacité liée : {name}', movePower: 'Puissance {value}', moveAccuracy: 'Précision {value} %',
  ...
  de: {
    ...
    relatedMove: 'Zugehörige Attacke: {name}', movePower: 'Stärke {value}', moveAccuracy: 'Genauigkeit {value} %',
  ...
  es: {
    ...
    relatedMove: 'Movimiento relacionado: {name}', movePower: 'Potencia {value}', moveAccuracy: 'Precisión {value} %',
  ...
  it: {
    ...
    relatedMove: 'Mossa correlata: {name}', movePower: 'Potenza {value}', moveAccuracy: 'Precisione {value}%',
  ...
  ja: {
    ...
    relatedMove: '対象わざ: {name}', movePower: '威力 {value}', moveAccuracy: '命中率 {value}%',
  ...
  ko: {
    ...
    relatedMove: '대상 기술: {name}', movePower: '위력 {value}', moveAccuracy: '명중률 {value}%',
  ...
  zh: {
    ...
    relatedMove: '相關招式：{name}', movePower: '威力 {value}', moveAccuracy: '命中率 {value}%',
