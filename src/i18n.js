const COPY = {
  en: {
    ...
    moveFilterSection: 'Move {name}', filterOptions: 'Filter options', resetFilterOrder: 'Reset filter order',
    ...
    affectedMoves: 'Affected moves with limited uses', relatedMove: 'Related move: {name}', movePower: 'Power {value}', moveAccuracy: 'Accuracy {value}%', moveUses: 'Uses {value}',
  ...
  fr: {
    ...
    moveFilterSection: 'Déplacer {name}', filterOptions: 'Options des filtres', resetFilterOrder: 'Réinitialiser l’ordre des filtres',
    ...
    affectedMoves: 'Capacités affectées à utilisations limitées', relatedMove: 'Capacité liée : {name}', movePower: 'Puissance {value}', moveAccuracy: 'Précision {value} %', moveUses: 'Utilisations {value}',
  ...
  de: {
    ...
    moveFilterSection: '{name} verschieben', filterOptions: 'Filteroptionen', resetFilterOrder: 'Filterreihenfolge zurücksetzen',
    ...
    affectedMoves: 'Betroffene Attacken mit begrenzten Einsätzen', relatedMove: 'Zugehörige Attacke: {name}', movePower: 'Stärke {value}', moveAccuracy: 'Genauigkeit {value} %', moveUses: 'Einsätze {value}',
  ...
  es: {
    ...
    moveFilterSection: 'Mover {name}', filterOptions: 'Opciones de filtros', resetFilterOrder: 'Restablecer orden de filtros',
    ...
    affectedMoves: 'Movimientos afectados con usos limitados', relatedMove: 'Movimiento relacionado: {name}', movePower: 'Potencia {value}', moveAccuracy: 'Precisión {value} %', moveUses: 'Usos {value}',
  ...
  it: {
    ...
    moveFilterSection: 'Sposta {name}', filterOptions: 'Opzioni filtri', resetFilterOrder: 'Reimposta ordine filtri',
    ...
    affectedMoves: 'Mosse interessate con utilizzi limitati', relatedMove: 'Mossa correlata: {name}', movePower: 'Potenza {value}', moveAccuracy: 'Precisione {value}%', moveUses: 'Utilizzi {value}',
  ...
  ja: {
    ...
    include: '含む',
    exclude: '除外',
    moveFilterSection: '{name}を移動', filterOptions: 'フィルタのオプション', resetFilterOrder: 'フィルタの順序をリセット',
    nameSearch: '名前',
    ...
    affectedMoves: '対象の回数制限わざ', relatedMove: '対象わざ: {name}', movePower: '威力 {value}', moveAccuracy: '命中率 {value}%', moveUses: '回数 {value}',
  ...
  ko: {
    ...
    moveFilterSection: '{name} 이동', filterOptions: '필터 옵션', resetFilterOrder: '필터 순서 초기화',
    ...
    affectedMoves: '대상 횟수 제한 기술', relatedMove: '대상 기술: {name}', movePower: '위력 {value}', moveAccuracy: '명중률 {value}%', moveUses: '사용 횟수 {value}',
  ...
  zh: {
    ...
    include: '包含',
    exclude: '排除',
    moveFilterSection: '移動{name}', filterOptions: '篩選選項', resetFilterOrder: '重設篩選順序',
    nameSearch: '名稱',
    ...
    affectedMoves: '受影響的次數限制招式', relatedMove: '相關招式：{name}', movePower: '威力 {value}', moveAccuracy: '命中率 {value}%', moveUses: '使用次數 {value}',
