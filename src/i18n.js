const COPY = {
  en: {
    ...
    multiplier: 'Multiplier: +{value}%', multiplierCap: 'Multiplier cap: +{value}%', statusChanceMultiplier: 'Status chance multiplier: ×{value}',
  ...
  fr: {
    ...
    multiplier: 'Multiplicateur : +{value} %', multiplierCap: 'Multiplicateur maximal : +{value} %', statusChanceMultiplier: 'Multiplicateur de probabilité d’altération : ×{value}',
  ...
  de: {
    ...
    multiplier: 'Multiplikator: +{value} %', multiplierCap: 'Maximaler Multiplikator: +{value} %', statusChanceMultiplier: 'Statuschance-Multiplikator: ×{value}',
  ...
  es: {
    ...
    multiplier: 'Multiplicador: +{value} %', multiplierCap: 'Multiplicador máximo: +{value} %', statusChanceMultiplier: 'Multiplicador de probabilidad de estado: ×{value}',
  ...
  it: {
    ...
    multiplier: 'Moltiplicatore: +{value}%', multiplierCap: 'Moltiplicatore massimo: +{value}%', statusChanceMultiplier: 'Moltiplicatore della probabilità di stato: ×{value}',
  ...
  ja: {
    ...
    loading: '結果を更新中…',
    multiplier: '倍率: +{value}%', multiplierCap: '倍率上限: +{value}%', statusChanceMultiplier: '異常確率倍率: ×{value}',
  ...
  ko: {
    ...
    loading: '결과 업데이트 중…',
    multiplier: '배율: +{value}%', multiplierCap: '최대 배율: +{value}%', statusChanceMultiplier: '상태 이상 확률 배율: ×{value}',
  ...
  zh: {
    ...
    loading: '正在更新結果…',
    multiplier: '倍率：+{value}%', multiplierCap: '倍率上限：+{value}%', statusChanceMultiplier: '異常機率倍率：×{value}',
